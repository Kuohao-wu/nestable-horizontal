    ...
    Plugin.prototype = {
        ...
        dragMove: function(e)
        {
            ...
            if (!mouse.dirAx || isNewRoot || isEmpty) {
                 ...
                 * offset(), 元素距离文档的距离
                 *
                 * this.pointEl 即将要被替换的元素
                 *
                 * this.placeEl 占位元素
                 */
                // var before = e.pageY < (this.pointEl.offset().top + this.pointEl.height() / 2);
                // 如果当前的鼠标横坐标大于占位元素的left，则是向后拖拽
                var after = e.pageX > this.placeEl.offset().left
                // 如果当前鼠标横坐标小于占位元素的left,则是向前拖拽
                var before = e.pageX < this.placeEl.offset().left
                    parent = this.placeEl.parent();
